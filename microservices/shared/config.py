...
class Config:
    ...
    TRAFFIC_CAPTURE_URL = os.environ.get('TRAFFIC_CAPTURE_URL', 'http://traffic-capture:5001')
    SIGNATURE_DETECTION_URL = os.environ.get('SIGNATURE_DETECTION_URL', 'http://signature-detection:5002')
    ...
    # Feature flags
    ENABLE_AI_DETECTION = os.environ.get('ENABLE_AI_DETECTION', 'true').lower() == 'true'
    ENABLE_RL_DETECTION = os.environ.get('ENABLE_RL_DETECTION', 'true').lower() == 'true'
    ENABLE_SIGNATURE_DETECTION = os.environ.get('ENABLE_SIGNATURE_DETECTION', 'true').lower() == 'true'
