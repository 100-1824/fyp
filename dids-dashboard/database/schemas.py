...
PACKETS_SCHEMA = {
    "validator": {
        "$jsonSchema": {
            ...
            "properties": {
                ...
                "protocol": {
                    "enum": ["TCP", "UDP", "ICMP", "ARP", "DNS", "HTTP", "HTTPS", "SSH", "FTP", "OTHER"],
    ...
    "indexes": [
        ...
        {"key": [("timestamp", -1)], "name": "timestamp_ttl", "expireAfterSeconds": 604800}  # 7 days
    ]
}
...
THREATS_SCHEMA = {
    "validator": {
        "$jsonSchema": {
            "bsonType": "object",
            "required": ["timestamp", "source", "destination", "threat_type", "severity"],
            "properties": {
                "timestamp": {
                    "bsonType": "date",
...
DETECTIONS_SCHEMA = {
            ...
            "properties": {
                ...
                "result": {
                    ...
                    "properties": {
                        ...
                        "confidence": {"bsonType": "double", "minimum": 0.0, "maximum": 100.0},
    ...
    "indexes": [
        {"key": [("timestamp", -1)], "name": "timestamp_desc"},
        {"key": [("detector_type", 1), ("timestamp", -1)], "name": "detector_timestamp"},
        {"key": [("result.is_threat", 1), ("timestamp", -1)], "name": "threat_timestamp"},
        {"key": [("flow_id", 1)], "name": "flow_id"},
        {"key": [("timestamp", -1)], "name": "timestamp_ttl", "expireAfterSeconds": 2592000}  # 30 days
    ]
}
...
FLOWS_SCHEMA = {
    ...
    "indexes": [
        ...
        {"key": [("source", 1), ("destination", 1), ("start_time", -1)], "name": "src_dst_time"},
        {"key": [("status", 1), ("last_seen", -1)], "name": "status_lastseen"},
        {"key": [("is_threat", 1), ("start_time", -1)], "name": "threat_time"},
        {"key": [("last_seen", 1)], "name": "lastseen_ttl", "expireAfterSeconds": 604800}  # 7 days
    ]
}
...
STATISTICS_SCHEMA = {
    "validator": {
        "$jsonSchema": {
            ...
            "properties": {
                ...
                "metric_type": {
                    "enum": ["traffic", "threats", "detections", "system", "performance"],
    ...
    "indexes": [
        ...
        {"key": [("timestamp", 1)], "name": "timestamp_ttl", "expireAfterSeconds": 7776000}  # 90 days
    ]
}
