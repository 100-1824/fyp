...
class DatabaseHelper:
    ...
    def get_recent_packets(self, limit: int = 100, threat_only: bool = False) -> List[Dict]:
        """Get recent packets"""
        try:
    ...
    def get_recent_threats(self, limit: int = 20, severity: Optional[str] = None) -> List[Dict]:
        """Get recent threats"""
        try:
            query = {}
            if severity:
    ...
    def get_threat_statistics(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            ...
            if result:
                ...
                return {'total_threats': 0, 'by_signature': {}, 'by_type': {}, 'by_severity': {}}
    ...
    def get_recent_alerts(self, limit: int = 50, unread_only: bool = False) -> List[Dict]:
        """Get recent alerts"""
        try:
    ...
    def insert_detection(self, detection_data: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            detection_data['timestamp'] = detection_data.get('timestamp', datetime.utcnow())
    ...
    def save_statistics(self, metric_type: str, period: str, stats_data: Dict[str, Any]) -> Optional[str]:
    ...
    def get_statistics(self, metric_type: str, period: str, hours: int = 24) -> List[Dict]:
    ...
    def log_event(self, level: str, component: str, message: str, **kwargs) -> Optional[str]:
        """Log a system event"""
        try:
            log_entry = {
                'timestamp': datetime.utcnow(),
