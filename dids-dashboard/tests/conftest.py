...
def mock_threat_service():
    ...
    service = Mock()
    service.detections = []
    service.stats = {"threats_blocked": 50, "alerts_generated": 75}
...
def reset_mocks(
    mock_packet_service, mock_threat_service, mock_ai_service, mock_rule_manager
):
...
def temp_rule_file():
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".rules", delete=False) as f:
        ...
        f.write(
            'alert udp any any -> any 53 (msg:"Test DNS Rule"; sid:9999998; rev:1;)\n'
        )
        temp_path = f.name
