...
def check_model_files():
    ...
    models_to_check = ["double_dqn_final.keras", "double_dqn_final_target.keras"]
    ...
    if all_good:
        ...
        print(
            "  python rl_module/test_dqn_model.py --model dids-dashboard/model/double_dqn_final.keras"
        )
    else:
        print("=" * 70)
